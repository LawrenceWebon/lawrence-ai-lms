...
| S-57 | pypdf package metadata | pypdf maintainers / PyPI | https://pypi.org/project/pypdf/ | 2026-08-31 | Before PDF parser upgrade | Version 6.16.2 is BSD-3-Clause, pure Python, typed, and classified for Python 3.14; lock and audit the exact release | capability-sensitive | 08,F-003,F-004 | Content/Platform/Security |
| S-58 | PdfReader contract | pypdf maintainers | https://pypdf.readthedocs.io/en/stable/modules/PdfReader.html | 2026-08-31 | Before PDF parser upgrade | Strict parsing and bounded root-object recovery are used as one admission defense; resource sandboxing remains local responsibility | capability-sensitive | 08,F-003,F-004 | Content/Platform/Security |
| S-59 | Text extraction and OCR boundary | pypdf maintainers | https://pypdf.readthedocs.io/en/stable/user/extract-text.html | 2026-08-31 | Before extraction/OCR upgrade | Layout text extraction is available; pypdf is not OCR and image-only pages require a separately approved OCR adapter | capability-sensitive | 08,F-004 | Content/Platform/QA |
